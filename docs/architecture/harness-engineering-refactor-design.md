...
- `frontend/src/components/travel-plan-toolkit/sections/itinerary/ItineraryDayCard.tsx`：185 行
...
- 继续把 `travel-plan-toolkit/sections/itinerary/ItineraryDayCard.tsx` 里的风险提醒、景点决策卡和 tips 区块再拆成更细的 view adapter
